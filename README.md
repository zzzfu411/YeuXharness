...
因此，当前适合协议、运行时和受控 mutation 开发，以及有边界的只读仓库探索；在最终名称 CAS/hostile-writer 证据、跨平台进程树监督、artifact/reconciliation UX 和真实任务 E2E 通过前，不应作为无监督自主编码工具使用。
